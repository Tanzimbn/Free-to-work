async function sort() {
    ...
    for (let i = 0; i < allpost.length; i++) {
        let html = `<div class="post-content">
            ...
            <div class="details">
                <p>${allpost[i].detail.substring(0, 30)}<span id="dots"> ...</span><button onclick="see_more(this)"
                        id="see_more">more</button><span id="more_details">${allpost[i].detail.substring(30)}</span>
