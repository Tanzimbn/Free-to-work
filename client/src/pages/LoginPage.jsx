    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
      ...
      <div className="relative grid w-full max-w-4xl overflow-hidden rounded-3xl border border-slate-800 bg-slate-950/80 shadow-2xl shadow-black/60 md:grid-cols-[1.1fr_minmax(0,1fr)]">
        ...
        <div className="flex flex-col justify-center px-6 py-6 md:px-8 md:py-8">
          ...
          <div className="mt-5 rounded-2xl border border-sky-500/25 bg-sky-500/8 p-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="h-1.5 w-1.5 rounded-full bg-sky-400" />
              <p className="text-[11px] font-semibold uppercase tracking-widest text-sky-400">Demo access</p>
            </div>
            <p className="text-xs text-slate-300 mb-3">
              Just want to explore? Try the app instantly — no registration needed.
            </p>
            <button
              type="button"
              onClick={handleDemoLogin}
              disabled={demoLoading}
              className="w-full rounded-full border border-sky-500/40 bg-sky-500/15 px-4 py-2 text-xs font-semibold text-sky-300 hover:bg-sky-500/25 hover:border-sky-400/60 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {demoLoading ? 'Loading demo...' : 'Enter as demo user'}
            </button>
          </div>
        </div>
      </div>
